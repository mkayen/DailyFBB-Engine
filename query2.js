	...
	for (var j = 0; j < length1; j++){
		...
		for (var i; i< length2; i++){
			...
			if(i!=j){
				...
				if(price>26000 && price <=28000 && points>125){
...
function positionEights(quadArray1, quadArray2, newArray){
	var length1 = quadArray1.length;
	var length2 = quadArray2.length;
	for (var j = 0; j < length1; j++){
		var i = j + 1
		for (var i; i < length2; i++){
			var pos1name = quadArray1[i][0]
			var pos2name = quadArray1[i][1]
			var pos3name = quadArray1[i][2]
			var pos4name = quadArray1[i][3]
			var pos5name = quadArray2[j][0]
			var pos6name = quadArray2[j][1]
			var pos7name = quadArray2[j][2]
			var pos8name = quadArray2[j][3]
			var price = quadArray1[i][4] + quadArray2[j][4]
			var points = quadArray1[i][5] + quadArray2[j][5]
			if(i!=j){
				posEight = []
...
function starting9(eight, allC, newArray){
